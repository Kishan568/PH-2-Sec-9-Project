...
namespace Project_4.Controllers
{
    ...
    {
        private readonly Project_4DbContext _context;

        public RainbowSchoolsController(Project_4DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<RainbowSchool>> PostRainbowSchool(RainbowSchool rainbowSchool)
        {
          if (_context.RainbowSchool == null)
          {
              return Problem("Entity set 'Project_4DbContext.RainbowSchool'  is null.");
          }
